  ...
  const steps = [
    {
      ...
      description: "Securely link your LinkedIn account in just one click. We'll analyze your profile and audience.",
      color: "text-blue-600",
      bgColor: "bg-blue-100",
    },
    {
      ...
      description: "Set your content preferences, posting schedule, and brand voice. Our AI learns your style.",
    ...
    },
    {
      ...
      description: "Sit back as Autorly creates, schedules, and optimizes your content automatically.",
